...
matchList.addEventListener('click', function(e){
    ...
    if (e.target.tagName === 'LI') {
        ...
        document.getElementById('prod_unitPk').innerHTML = selectedUnitpk;
        document.getElementById('prod_schemeRange').innerHTML = selectedschemerange;
        document.getElementById('prod_schemeOffQty').innerHTML = selectedschemeoffqty;
    }
});
...
document.getElementById('cart_btn').onclick = function(){
    //location.href = "cart.html";
    const cartList = document.querySelectorAll('.cart_list');
