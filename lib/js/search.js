...
matchList.addEventListener('click', function(e){
    ...
    if (e.target.tagName === 'LI') {
        ...
        let qunt = e.target.children[0].innerText;//Get selected product schemeHalfValuePerc
        ...
        localStorage.setItem('spanschemeHalfValuePerc',qunt);//Store prod quantity
        ...
        var selectedQuant = localStorage.getItem('spanschemeHalfValuePerc');
        ...
        document.getElementById('prod_schemeValue').innerHTML = selectedQuant;//Prod quantity
