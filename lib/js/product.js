...
//Get all the selected product info from local storage
      ...
      console.log(newprod,"newprod");
                ...
                for (var i = 0; i < newprod.length; i++) {
                  console.log(newprod[i].lineItems,"lineItems");
                    ...
                    htmltable+='<td class="prodName">'+newprod[i].lineItems[0].proName+'</td>';
          ...
          e = window.event;
             ...
             document.getElementById('custBack').style.display = 'block';
              ...
              if(e.target.value == "Delete"){
                ...
                if (cartLineitem.length == 0) {
                  var localdevicesArray = localStorage.getItem('devicesArray');
                  newprod.splice(localdevicesArray, 1);
                  localStorage.setItem('custCartList', JSON.stringify(newprod));
                  ...
                  console.log(cartLineitem.length,"cartLineitem.length");
                }
                let sum = [];
                var tot=0;

                  for (var i = 0; i < cartLineitem.length; i++) {
                      var prodtotal = cartLineitem[i].qty * cartLineitem[i].proRate;
                      sum.push(prodtotal);
                      let total = sum.reduce((a, b) => a + b, 0)
                      document.getElementById("prodTotal").innerHTML = "Items: "+cartLineitem.length+" Total Value : "  +'<span> &#8377; </span>' +total.toFixed(2);
                      document.getElementById("prodTotalTable").innerHTML = "Items: "+cartLineitem.length+" Total Value : "  +'<span> &#8377; </span>' +total.toFixed(2);                
                  }
    ...
    function update(event){
        ...
        $('input[name="cartQuant"]').on('change', function(){
            ...
            if (current == ''|| current == 0) {
              ...
              let devicesArray = localStorage.getItem('devicesArray');
              let cartLineitem = newprod[devicesArray].lineItems;
              console.log(cartLineitem.length,"cartLineitem");
    ...
    function orderupdate(){
      let updatecart = JSON.parse(localStorage.getItem('custCartList'));
      const cartData = 
                  {
                      "userName":"",
                      "lineItems":"" 
              ...
              console.log(cartData.lineItems,"cartData.lineItems");
                const addcarturl = "https://raw.githubusercontent.com/BACreator/tulsicropSales/main/lib/json/orderresponsefromdb.json?n=1";
                          ...
                          return response.json();
                            ...
                            console.log(data,"respond data");
                              ...
                              if (data.userName !== cartData.userName) {
                                ...
                                localStorage.setItem('custCartList', JSON.stringify(dbcartlist));
                                
                                //localStorage.setItem('products', JSON.stringify(dbcartlist));
                                console.log(JSON.parse(localStorage.getItem('custCartList')),"custCartList");
    ...
    function getCustomerFromStorage(){
      ...
      console.log(newprod,"newprod");
                  ...
                  for (var i = 0; i < newprod.length; i++) {
                    ...
                    console.log(cartLineitem,"cartLineitem");
                      htmltable+='<tr  onclick="custclick(event)" class="custNames">';
                      htmltable+='<td>'+newprod[i].custName+'</td>';
       ...
       e = window.event;
        ...
        if (curHr < 12) {
          ...
          document.getElementById('custaddr').style.display = 'block';
           ...
           console.log(newprod,"newprod");
           console.log(newprod[devicesArray].lineItems,"newprod");
           document.getElementById('custname').innerHTML = newprod[devicesArray].custName;
           document.getElementById('custarea').innerHTML = newprod[devicesArray].areaCode;
           document.getElementById('custadd1').innerHTML = newprod[devicesArray].address1;
           document.getElementById('custadd2').innerHTML = newprod[devicesArray].address2;
           ...
           document.getElementById("cartTable").innerHTML = carttable;
             ...
             /*if(e.target.value == "Delete"){
              ...
              document.getElementById('prodTotalTable').style.display = 'block';
    ...
    function checkOut(){
       ...
       let localdevicesArray = localStorage.getItem('devicesArray');
       var selectedprod = localStorage.getItem('custCartList');
       const newprod = JSON.parse(selectedprod);
       console.log(newprod,"newprod");
       console.log(newprod[localdevicesArray].lineItems,"newprod");

       let cartLineitem = newprod[localdevicesArray].lineItems;
       console.log(cartLineitem,"cartLineitem");
       ...
       /* let finalProd = JSON.parse(localStorage.getItem('order'));
        ...
        const shopdata = 
                ...
                //shopdata.custName = 
                shopdata.lineItems = cartLineitem;
                console.log(shopdata.lineItems,"shopdata.lineItems");
                                    ...
                                    return response.json();
                                        ...
                                        if (data.responseCode == '0000') {
                                          ...
                                          console.log(shopdata,"shopdata");
                                            ...
                                            cartTotal();
                                            console.log(newprod,"newprod");
                                            console.log(localdevicesArray,"localdevicesArray");
                                            newprod.splice(localdevicesArray, 1);
                                            localStorage.setItem('custCartList', JSON.stringify(newprod));
                                            ...
                                            getCustomerFromStorage();
                                              /*/ document.getElementById('cartdsTable').innerHTML = "";
    ...
    function cstomerlist(){
      ...
      document.getElementById('prodTotalTable').style.display = 'none';
      ...
      const newprod = JSON.parse(selectedprod);
      if (newprod.length == 0) {
                    localStorage.removeItem('custCartList');
                    document.getElementById('Cartempty').style.display = 'block';
                  }else{console.log("custCartList is not empty");}
    }
    ...
    document.getElementById('cart_btn').onclick = function(product){
      ...
      if ((localStorage.getItem("username") === null) || (localStorage.getItem("username") === '')) {
        ...
        const cartData = 
                ...
                console.log(cartData,"cartData");
                const carturl = "https://raw.githubusercontent.com/BACreator/tulsicropSales/main/lib/json/orderresponsefromdb.json?n=1";
                ...
                fetch(carturl, {cache: "no-store"} /*{
                     ...
                     body: JSON.stringify(get data from database)
                            ...
                            return response.json();
                              ...
                              console.log(data,"respond data");
                              console.log(cartData.username,"loginUser");
                              console.log(data.userName,"responseUser");
                                if (data.error) {
                                alert("Something went wrong...!");
                                }else{
    	...
    	if ((localStorage.getItem("custCartList") === null) || (localStorage.getItem("custCartList") === '')) {
    		emptyCart();
    	}else{carodLayout.style.display = 'none';getCustomerFromStorage();cartTotal();}
  }
  ...
  /*  document.getElementById('cart_btn1').onclick = function(product){
        ...
        if ((localStorage.getItem("username") === null) || (localStorage.getItem("username") === '')) {
          ...
          const cartData = 
                  ...
                  cartData.lineItems = finalProd;
                  console.log(cartData,"cartData");
                  const carturl = "https://raw.githubusercontent.com/BACreator/tulsicropSales/main/lib/json/orderresponsefromdb.json.json?n=1";
                  //const carturl = "lib/json/orderresponsefromdb.json?n=1";
                  //const orderurl = "https://www.tulsicorp.com/mobile-order-entry-service/createmobileorder/";
                  fetch(carturl, {cache: "no-store"} /*{
                       headers: {
